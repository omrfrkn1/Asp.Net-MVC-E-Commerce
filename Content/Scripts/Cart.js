        ...
        cart.forEach(item => {
            $.ajax({
                ...
                success: function (result) {
                    ...
                    const product = `
                        <div class="card mb-4 me-auto w-100 rounded-4" style="height: 150px;">
                            <div class="container-fluid h-100">
                                <div class="row h-100">
                                    <div class="col-md-2 d-flex h-100">
                                        <img src="/Content/Images/ProductImages/`+result.Id+`/1.jpg" class="rounded-start m-auto h-75">
                                    </div>
                                    <div class="col-md-7">
                                    ...
                                    <div class="col-md-3 px-5 py-3 h-100" style="z-index: 2;">
